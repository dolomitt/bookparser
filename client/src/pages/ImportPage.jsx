...
import LiveTaskPopup from '../components/import/LiveTaskPopup';
import TokenizedText from '../components/import/TokenizedText';
              ...
              return (
                <span key={sentenceIndex} className={sentenceContainerClassName}>
                  ...
                  {' '} {/* Space between sentences */}
                    ...
                    <LiveTaskPopup
            popup={ollamaStreamPopup}
            onClose={() => setOllamaStreamPopup((prev) => ({ ...prev, visible: false }))}
          />
